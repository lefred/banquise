...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Package.metainfo'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['web.MetaInfo'], null=True, blank=True))
        db.alter_column('web_package', 'metainfo_id', orm['web.package:metainfo'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Package.metainfo'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['web.MetaInfo'], null=True))
        db.alter_column('web_package', 'metainfo_id', orm['web.package:metainfo'])
