...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contract.license'
        db.add_column('web_contract', 'license', orm['web.Contract:license'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Contract.license'
        db.delete_column('web_contract', 'license')
