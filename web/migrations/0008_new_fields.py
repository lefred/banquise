...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('web_package', 'repo', orm['web.package:repo'])
        
        # Adding field 'ServerPackages.new_install'
        db.add_column('web_serverpackages', 'new_install', orm['web.serverpackages:new_install'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('web_package', 'repo')
        
        # Deleting field 'ServerPackages.new_install'
        db.delete_column('web_serverpackages', 'new_install')
    ...
    models = {
        ...
        'web.package': {
            ...
            'repo': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True', 'null': 'True'}),
